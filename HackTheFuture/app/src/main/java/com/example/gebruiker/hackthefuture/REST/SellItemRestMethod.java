 ...
 */
public class SellItemRestMethod extends AbstractRestMethod<Void>{
    private Context context;
    private String itemId;
    private Integer amount;

    public SellItemRestMethod(Context context) {
    ...
    protected Request buildRequest() {
        try {
            URI REQURI = URI.create("http://cloud.cozmos.be:2400/api/sell");
