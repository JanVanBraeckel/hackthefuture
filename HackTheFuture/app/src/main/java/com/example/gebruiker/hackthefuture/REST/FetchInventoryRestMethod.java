 ...
 */
public class FetchInventoryRestMethod extends AbstractRestMethod<List<Item>> {
    private static final URI REQURL = URI.create("http://cloud.cozmos.be:2400/api/inventory");
    private Context context;
    private String email, password;

    public FetchInventoryRestMethod(Context context) {
